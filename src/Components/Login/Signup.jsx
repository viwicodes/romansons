...
const LoginComp = () => {
  ...
  return (
    <div style={{
      ...
      <div className="container-fluid h-100 g-0 login-bg" style={{ boxSizing: "unset" }} onLoad={() => { LoginAnimation() }}>
        <div className="login-cont">
          <div>
            ...
            <div className="login-cont-right">
              <div className="login-form-cont" style={{ bottom: "4rem" }}>
                <div className="login-header">Signup</div>
                <div className="inputContainer">
                  <label className="login-label">Email</label>
                  <input type="text" onChange={(e) => handleEmail(e)} className="input" placeholder="" />
                  {/* <ErrorMessage name="e_mail" component="span" />
                <br />
                <Field id="e_mail" name="e_mail" /> */}
                </div>
                <div className="inputContainer">
                  <label className="login-label">Password</label>
                  <input type="text" onChange={(e) => handlePassword(e)} className="input" placeholder="" />
                  <br />
                </div>
                <div className="inputContainer">
                  <label className="login-label">Confirm Passwod</label>
                  <input
              ...
              <img src={logo} className="login-right-logo"></img>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="41.568"
                height="60.667"
              ...
              <svg
                ...
                viewBox="0 0 703.045 683.321"
                className="login-svg-2"
                style={{ transform: "scale(0.75) translate(61%, 45%)" }}
              >
                <g
                  id="Group_3"
                  data-name="Group 3"
            ...
            <div className="login-cont-bg"></div>
